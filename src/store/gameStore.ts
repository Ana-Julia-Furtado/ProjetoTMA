...
const generateMockOnlineUsers = (): User[] => {
  const mockUsers = [
    ...
    { id: '176563', name: 'Livia de Moura Carvalho', email: '12345@student.edu', level: 10, totalScore: 1100, gamesPlayed: 6, correctAnswers: 38 },
    { id: '1639111', name: 'Lucas Alves Marques', email: '12345@student.edu', level: 10, totalScore: 1100, gamesPlayed: 6, correctAnswers: 38 }];
